...
public class BucketHead_Zombie extends Zombie {
	...
	public BucketHead_Zombie(int col, int row, GameWorld game) {
		super(game, col, row, ENDURANCE, DAMAGE);
		this.ciclo_zombie = 0;

	}

	public BucketHead_Zombie() {

	}

	public String getSymbol() {
		return Messages.BUCKET_ZOMBIE_SYMBOL;
	}

	public String getDescription() {
		return String.format(Messages.BUCKET_ZOMBIE_NAME + ": speed:'" + SPEED + "' damage='" + DAMAGE + "' endurance='"
				+ ENDURANCE + "'");
	}
	...
	public Zombie createZombie(int col, int row, GameWorld game) {
		return new BucketHead_Zombie(col, row, game);
	}
