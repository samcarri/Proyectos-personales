...
public class Sporty_Zombie extends Zombie {
	...
	public Sporty_Zombie(int col, int row, GameWorld game) {
		super(game, col, row, ENDURANCE, DAMAGE);
		this.ciclo_zombie = 0;

	}

	public Sporty_Zombie() {
	...
	public String getDescription() {
		return String.format(Messages.SPORTY_ZOMBIE_NAME + ": speed:'" + SPEED + "' damage='" + DAMAGE + "' endurance='"
				+ ENDURANCE + "'");
	}
	...
	public Zombie createZombie(int col, int row, GameWorld game) {
		return new Sporty_Zombie(col, row, game);
	}
